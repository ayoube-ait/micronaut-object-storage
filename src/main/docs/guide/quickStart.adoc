...
When no content type is supplied, the request may infer one from the object key suffix as a convenience. This inference
does not inspect or validate the stream contents.
